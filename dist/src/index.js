...
var ruby_default = "../ruby-q1cd8t3e.rb";
...
console.log("rubyContent", ruby_default);
console.log("rubyScriptPath", ruby_default);
...
var rubyBuildCommand = (projectConfigPath, rubyConfigPath, testName) => {
  return `ruby /workspace/testeranto/ruby/ruby.rb /workspace/${rubyConfigPath}`;
};
