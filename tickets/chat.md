...
1) agents POST to the chat endpoint to make messages.
2) The server integrates this message into the graph
3) Each agent's slice is written, which includes all the chat messages from all agents.
