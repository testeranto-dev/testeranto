...
func TestNativeGoTest(t *testing.T) {
	...
	t.Run("addition", func(t *testing.T) {
		...
		When("adding 5", func(data interface{}) interface{} {
			d := data.(*struct{ value int })
			d.value += 5
			return d
		}).
		Then("value should be 5", func(data interface{}) {
			d := data.(*struct{ value int })
			if d.value != 5 {
	...
	t.Run("subtraction", func(t *testing.T) {
		...
		When("subtracting 3", func(data interface{}) interface{} {
			d := data.(*struct{ value int })
			d.value -= 3
			return d
		}).
		Then("value should be 7", func(data interface{}) {
			d := data.(*struct{ value int })
			if d.value != 7 {
...
func TestGolingvuCompatibility(t *testing.T) {
	...
	When("transforming", func(data interface{}) interface{} {
		return data.(string) + "-transformed"
	}).
	Then("should be transformed", func(data interface{}) {
...
func TestFlavoredToGolingvu(t *testing.T) {
	...
	When("adding 50", func(n interface{}) interface{} {
		return n.(int) + 50
	}).
	Then("should be 150", func(n interface{}) {
		if n.(int) != 150 {
...
func TestNativeGoToolchainIntegration(t *testing.T) {
	...
	t.Run("test with subtests", func(t *testing.T) {
		...
		When("transforming", func(s interface{}) interface{} {
			return s.(string) + "-transformed"
		}).
		Then("should be transformed", func(s interface{}) {
