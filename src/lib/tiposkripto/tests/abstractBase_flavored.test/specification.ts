...
export const specification: ITestSpecification<I, O> = (
  Suite: { Default: (arg0: string, arg1: { initialization?: any; errorHandling?: any; stateModification?: any; errorPropagation?: any; assertionPassing?: any; assertionFailing?: any; }) => any; },
  Given: { Default: (arg0: string[], arg1: any[], arg2: any[]) => any; WithError: (arg0: string[], arg1: any[], arg2: any[]) => any; },
  When: { throwError: () => any; modifyStore: (arg0: string) => any; },
  Then: { verifyStore: (arg0: string) => any; verifyError: (arg0: string) => any; }
) => [
