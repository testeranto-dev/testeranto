...
import { TestData, TestGiven } from "./helpers";

export function renderTestDetails(testData: TestData | null) {
    ...
    <div style={{ marginTop: "20px" }}>
      ...
      {testData.testJob && testData.testJob.givens && (
        <div>
          ...
          {testData.testJob.givens.map((given: TestGiven, index: number) => (
            <div
              key={index}
              style={{
                marginBottom: "20px",
