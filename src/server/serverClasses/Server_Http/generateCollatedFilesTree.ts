...
//         (async () => {
//           try {
//             // Fetch input files (using deprecated endpoint)
//             const inputUrl = `http://localhost:3000${vscodeHttpAPI.getInputFiles.path}?runtime=${encodeURIComponent(runtime)}&testName=${encodeURIComponent(testName)}`;
...
//             // Fetch output files (using deprecated endpoint)
//             const outputUrl = `http://localhost:3000${vscodeHttpAPI.getOutputFiles.path}?runtime=${encodeURIComponent(runtime)}&testName=${encodeURIComponent(testName)}`;
