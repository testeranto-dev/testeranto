...
var KanbanBoard = (props) => {
  ...
  const renderColumns = () => {
    ...
    return config.columns.map((column, index) => {
      ...
      return /* @__PURE__ */ React2.createElement("g", { key: `column-${column.id}` }, /* @__PURE__ */ React2.createElement(
        "rect",
        {
          x: columnX,
          y: 0,
  ...
  return /* @__PURE__ */ React2.createElement("svg", { width, height, style: { border: "1px solid #ccc" } }, renderColumns(), /* @__PURE__ */ React2.createElement(BaseChart, { ...props }));
};
export {
  KanbanBoard
};
