...
var GanttChart = (props) => {
  ...
  const renderTimeline = () => {
    ...
    return Array.from({ length: segments }).map((_, i) => {
      ...
      return /* @__PURE__ */ React2.createElement("g", { key: `timeline-${i}` }, /* @__PURE__ */ React2.createElement(
        "line",
        {
          x1: x,
          y1: 0,
  ...
  return /* @__PURE__ */ React2.createElement("svg", { width, height, style: { border: "1px solid #ccc" } }, renderTimeline(), /* @__PURE__ */ React2.createElement(BaseChart, { ...props }));
};
export {
  GanttChart
};
