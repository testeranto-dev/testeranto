...
(() => {
  ...
  // testeranto/views/Chat.wrapper.tsx
  var import_react3 = __toESM(require_react(), 1);
  var import_client = __toESM(require_client(), 1);

  // src/vscode/views/defaultViews/ChatView.tsx
  ...
  var Chat = class extends BaseViewClass {
    constructor() {
      super(...arguments);
      __publicField(this, "state", {
        ...this.state,
      ...
      __publicField(this, "loadData", async () => {
        try {
      ...
      __publicField(this, "sendMessage", async () => {
    ...
    renderMessage(message, index) {
      ...
      const containerStyle = {
        ...messageStyle,
        cursor: this.props.onNodeClick ? "pointer" : "default"
      };
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "div",
        {
          style: containerStyle,
          onClick: () => this.props.onNodeClick?.(message),
          onMouseEnter: () => this.props.onNodeHover?.(message),
          onMouseLeave: () => this.props.onNodeHover?.(null),
          children: [
            config.showAgentNames && message.agentName && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: agentStyle, children: message.agentName }),
            config.showTimestamps && message.timestamp && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: timestampStyle, children: new Date(message.timestamp).toLocaleString() }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: contentStyle, children: message.content })
          ]
        },
    ...
    renderContent() {
      ...
      if (!data || !data.messages) {
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: "No chat messages found" }) });
      }
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { maxWidth: "800px", margin: "0 auto" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: {
            marginBottom: "20px",
            paddingBottom: "10px",
            borderBottom: "2px solid #4a90e2"
          }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { style: { margin: 0, color: "#333" }, children: "Chat Messages" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: "14px", color: "#666" }, children: [
              messages.length,
              " message",
              messages.length !== 1 ? "s" : ""
            ] })
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              ...
              children: this.state.sending ? "Sending..." : "Send"
            }
          )
        ] })
      ] });
  ...
  if (rootElement) {
    ...
    root.render(
      import_react3.default.createElement(ChatView_default, {
        slicePath: "/testeranto/slices/views/Chat.json"
      })
    );
  }
})();
