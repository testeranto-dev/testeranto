...
(() => {
  ...
  // src/vscode/views/defaultViews/GanttView.tsx
  ...
  var GanttView_default = GanttView;
  ...
  if (rootElement) {
    ...
    root.render(
      import_react3.default.createElement(GanttView_default, {
        slicePath: "/testeranto/slices/views/Gantt.json"
      })
    );
  }
})();
