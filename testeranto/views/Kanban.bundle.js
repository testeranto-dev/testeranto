...
(() => {
  ...
  // src/vscode/views/defaultViews/KanbanBoardView.tsx
  ...
  var KanbanBoardView_default = KanbanView;
  ...
  if (rootElement) {
    ...
    root.render(
      import_react3.default.createElement(KanbanBoardView_default, {
        slicePath: "/testeranto/slices/views/Kanban.json"
      })
    );
  }
})();
